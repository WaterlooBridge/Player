...
@UnstableApi
public final class ShadowHlsExtractorFactory implements HlsExtractorFactory {
    ...
    /**
     * Equivalent to {@link #ShadowHlsExtractorFactory(int, boolean) new
     * DefaultHlsExtractorFactory(payloadReaderFactoryFlags = 0, exposeCea608WhenMissingDeclarations =
     * true)}
     */
    public ShadowHlsExtractorFactory() {
    ...
    @Override
    public ShadowBundledHlsMediaChunkExtractor createExtractor(
            Uri uri,
            Format format,
        ...
        for (int i = 0; i < fileTypeOrder.size(); i++) {
            ...
            if (sniffQuietly(extractor, sniffingExtractorInput)) {
                return new ShadowBundledHlsMediaChunkExtractor(extractor, format, timestampAdjuster);
            }
        ...
        return new ShadowBundledHlsMediaChunkExtractor(
    ...
    private static ShadowTsExtractor createTsExtractor(
        ...
        return new ShadowTsExtractor(
                ShadowTsExtractor.MODE_HLS,
                timestampAdjuster,
